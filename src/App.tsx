...
function App() {
  ...
  const getIframeSrc = () => {
    ...
    return "https://copilotforservice-prod.azureedge.net/widget/index.html?dynamicsUrl=https://org702cec4c.crm10.dynamics.com&copilotExtensionUrl=https://embedcopilotnonprod.blob.core.windows.net/embedcopilotnonprodcontainer/portalExtension.js";
